<?php /*
  ...
  Version: 0.1
  Author: Denis Alekseev, Alexander Kurganov
  Author URI: http://loom-studio.net/, http://akurganow.ru
 */
...
class WC_ROBOKASSA extends WC_Payment_Gateway
{
	public function __construct()
	{
		...
		$this->id = 'robokassa';
		$this->icon = apply_filters('woocommerce_robokassa_icon', $woocommerce->plugin_url().'/assets/images/icons/robokassa.png');
